...
The main objective of determining the correct stacking sequence for the composite specimen was successful. Additionally, use of LPT in conjunction with mechanical testing was found to be an effective method for completion of this objective. Our findings  from the mechanical testing best align with the LPT results of Layup 3  ($[(90)_2/(0)_4/(90)_2]_S$). While methods used in this experiment  were successful for the given boundaries and specimen dimension it may prove to be ineffective for other situations, such as composites with  a much larger number of plies. Future experimentation using digital image correlations is recommended since strain measurements through the thickness.  
\section{Figures}
